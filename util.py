...
class Comp():
    ...
    def comp(self, value1, value2, mode: str = "AND") -> bool:
    ...
    def comp_str(self, value1: str, value2: str, mode: str = "AND") -> bool:
        if mode == "AND":
            return self.comp_str_AND(value1, value2)
        elif mode == "OR":
            return self.comp_str_OR(value1, value2)
        elif mode == "except":
            return self.comp_str_except(value1, value2)
        else:
            return False
        
    def comp_int(self, value1: int, value2: int, mode: str = "AND") -> bool:
        if mode == "AND":
            return self.comp_int_AND(value1, value2)
        elif mode == "OR":
            return self.comp_int_OR(value1, value2)
        elif mode == "except":
    ...
    def comp_str_AND(self, value1: str, value2: str) -> bool:
        return value1 == value2

    def comp_str_OR(self, value1: str, value2: str) -> bool:
        return (value2 in value1) | (value1 in value2)

    def comp_str_except(self, value1: str, value2: str) -> bool: # 여집합
        return not self.comp_str_OR(value1, value2)

    def comp_int_AND(self, value1: int, value2: int) -> bool:
        return value1 == value2

    def comp_int_OR(self, value1: int, value2: int) -> bool:
        return (str(value2) in str(value1)) | (str(value1) in str(value2))

    def comp_int_except(self, value1: int, value2: int) -> bool: # 여집합
        return not self.comp_int_OR(value1, value2)
